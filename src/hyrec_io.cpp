...
void read_alpha(const string& root, external_info* info) {
  ...
  ifstream alpha_file(alpha_filename.str().c_str());
  ...
  if (alpha_file.is_open()) {
    ...
    cerr << "[ERROR]: Could not read in Alpha file '"
              << alpha_filename.str() << "'"
              << endl;
...
void read_RR(const string& root, external_info* info) {
  ...
  ifstream RR_file(RR_filename.str().c_str());
  ...
  if (RR_file.is_open()) {
    ...
    cerr << "[ERROR]: Could not read in RR file '"
              << RR_filename.str() << "'"
              << endl;
...
void read_two_photon(const string& root, external_info* info) {
  ...
  ifstream two_phot_file(two_phot_filename.str().c_str());
