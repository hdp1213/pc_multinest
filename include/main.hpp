...
inline void
pc_multinest(void (*loglike)(double*,
                             int&,
                             int&,
                             double&,
                             void*),
             ...
             void* context) {
  nested::run(s.IS, s.mmodal, s.ceff, s.nlive, s.tol, s.efr,
              s.ndims, s.nPar, s.nClsPar, s.maxModes, s.updInt,
              s.Ztol, s.root, s.seed, s.pWrap, s.fb, s.resume,
              s.outfile, s.initMPI, s.logZero, s.maxiter,
