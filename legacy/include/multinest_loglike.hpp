...
// Function to be minimized.  Corresponds to ln(Likelihood).  Redirects
//  to the target of context pointer.
// Cube contains only free and derived parameters. To begin, free params
//  are in [0,1] range
// At the end of likelihood computation, the latter part of the array has
//  derived parameters set as appropriate
